...
<head>
    ...
    <title>SureShore - Add Beach</title>
...
<body class="d-flex flex-column min-vh-100">
    ...
    <section class="bg-ocean text-white py-4">
        <div class="container">
            ...
            <h1 class="fw-bold mt-2 mb-0">Add New Beach</h1>
        </div>
    </section>
                    ...
                    <div class="card-body p-4">
                        ...
                        <form action="{{ route('beaches.store') }}" method="POST">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="url" class="form-control" id="quality_results" name="quality_results" value="{{ old('quality_results') }}" required>
                            </div>

                            <button type="submit" class="btn btn-success">Add Beach</button>
                            <a href="/beaches" class="btn btn-outline-secondary ms-2">Cancel</a>
                        </form>
